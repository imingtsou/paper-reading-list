...
\resizebox{\textwidth}{!}{
    ...
    \hline
    Platform & Tensorflow & CNTK & Deeplearning4j & MXNet & H2O & CaffeOnSpark & Theano & Torch \\ \hline\hline
    ...
    \hline
    Communication Model & Parameter server & MPI & Iterative MapReduce & Parameter server & Distributed fork-join & MPI Allreduce & N/A & N/A \\
    \hline
    Multi-GPU & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark \\
    \hline 
    Multi-node & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark & \xmark & \xmark \\
    \hline
